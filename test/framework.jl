using StochDynamicProgramming,  JuMP, Clp #, ECOS#,Gurobi, CPLEX#
using Xpress

solverLP = with_optimizer(Xpress.Optimizer)
solverQP = Clp.Optimizer() #ECOSSolver()# GurobiSolver(OutputFlag=0)#  #CplexSolver(CPX_PARAM_SIMDISPLAY=0)
